...
public class GNCBuscarTernera extends JInternalFrame  {
	...
	private static GNCNuevoTerneraEnferma  nuevoTerneraEnferma;
	/**
	 * Create the frame.
	 * @throws TerneraException 
	 **/
	public GNCBuscarTernera() throws TerneraException {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
		        ...
		        long idEnfermedad = Long.parseLong( table.getModel().getValueAt(row, 0).toString() );
		        if (arg0.getClickCount() == 2) {

		        	GNCNuevoTerneraEnferma.txtTernera.setText(String.valueOf(idEnfermedad));
		        	dispose();
