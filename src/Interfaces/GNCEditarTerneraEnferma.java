...
public class GNCEditarTerneraEnferma extends JInternalFrame {
	...
	public void cargarDatosDeLaBD() throws NamingException, TerneraEnfermaException{
		//Obtengo la materia de id el que me pasan por par�metro en el constructor
	...
	private void accionGuardar() throws TerneraEnfermaException{
		...
		if (almacenado) {
			JOptionPane.showInternalMessageDialog(this, "la  Enfermedad por Ternera se ha sido registrado con �xito.",
